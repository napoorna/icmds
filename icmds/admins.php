...
if (isset($_SESSION['icmds_login'])) {
  ...
  if (isset($_POST['submitadmin'])) {
    ...
    $check = $mysqli->query("SELECT id FROM admin WHERE email = '$email'");
    if ($check->num_rows > 0) {
      echo '<script language="javascript">';
      echo 'alert("An account with this Email ID already exists");';
      ...
      if ($mysqli->query($insert)) {
        ...
        echo '<script language="javascript">';
        echo 'alert("Failed to Create Account, try Again");';
        echo 'window.location.href = "admins"';
        echo '</script>';
      }
    }
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
              <div class="card">
                <div class="body">
                  <center><h3>Add New Admin</h3></center><br>
                  <form id="form_validation" method="POST" action="admins">
                      <div class="col-sm-12">
                        <div class="col-sm-6">
                      ...
                      <center><button class="btn btn-primary waves-effect" type="submit" name="submitadmin">Create Account</button></center>
                  </form>

                  <center><h3>Admin Database</h3></center>
