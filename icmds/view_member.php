...
<head>
    ...
    <title>View Members | ICMDS</title>
    <!-- Favicon-->
            ...
            <div class="row">
              <div class="card">
                ...
                <div class="body" style="padding:3%;">
                  <center><h3>Membership Details</h3></center><br><br>
                  <form>
                    <div>
                    <div class="col-sm-6">
                      <label>User ID</label>
                      <div class="form-group">
                          <div class="form-line">
                              <input type="text" class="form-control" readonly value="<?php echo $row['user_id']?>">
                          </div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      ...
                      <br><hr>
                      <h4 class="text-center">All Subscriptions</h4>
